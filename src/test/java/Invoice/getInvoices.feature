Feature: Get Invoices
  ...
  Scenario: Verify get Invoices API return All invoices
    ...
    And match $.invoices[0].invoiceId == "VI-dnvtest-000000084"
    And match $.invoices[0].billNo == "inv1234"
    And match $.invoices[0].billTo.name == "Mumbai-Branch"
    And match $.invoices[0].billTo.gstin == "27AABCD0052F1Z8"
